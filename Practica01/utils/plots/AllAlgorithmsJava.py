...
a, b = np.loadtxt('../../data/BubbleSort/valores_java.txt',
                  delimiter=',',
                  unpack=True)
c, d = np.loadtxt('../../data/CountingSort/valores_java.txt',
                  delimiter=',',
                  unpack=True)
e, f = np.loadtxt('../../data/HeapSort/valores_java.txt',
                  delimiter=',',
                  unpack=True)
g, h = np.loadtxt('../../data/InsertionSort/valores_java.txt',
                  delimiter=',',
                  unpack=True)
i, j = np.loadtxt('../../data/MergeSort/valores_java.txt',
                  delimiter=',',
                  unpack=True)
k, l = np.loadtxt('../../data/QuickSort/valores_java.txt',
                  delimiter=',',
                  unpack=True)
